...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "model_lrmconppo");
    reader.add_event(121, 119, "end", "model_lrmconppo");
    return reader;
}
...
class model_lrmconppo
  : public stan::model::model_base_crtp<model_lrmconppo> {
private:
        int N;
        int p;
        int q;
...
public:
    model_lrmconppo(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "model_lrmconppo_namespace::model_lrmconppo";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "model_lrmconppo_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef model_lrmconppo_namespace::model_lrmconppo stan_model;
#ifndef USING_R
